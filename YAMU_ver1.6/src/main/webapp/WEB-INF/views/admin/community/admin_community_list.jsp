 ...
 */
 //public static String renderingPager(int maxNum, int currentPageNo, int rowPerPage, int bottomCount, String url, String scriptName) {
  ...
  //out.print("cp****" + cp);
  String pageHtml = StringUtil.renderingPager(maxNum, pageNo, pageSize, bottomCount, cp + "/admin/adminRetrieveCommunity.do", "pageDoRetrieve");
%>
<!DOCTYPE html>
<html>
<head>
...
<script src="${CP}/resources/assets/js/admin/community/admin_community_list.js?date=<%=new Date()%>"></script>
</head>
<body>
  <div class="main-container">
    ...
    <div class="main-content-container">
			...
			<jsp:include page="/WEB-INF/views/admin/community/admin_community_mng.jsp"></jsp:include>
			<jsp:include page="/WEB-INF/views/admin/community/admin_community_reg.jsp"></jsp:include>
