 ...
 */
 //public static String renderingPager(int maxNum, int currentPageNo, int rowPerPage, int bottomCount, String url, String scriptName) {
  ...
  //out.print("cp****" + cp);
  String pageHtml = StringUtil.renderingPager(maxNum, pageNo, pageSize, bottomCount, cp + "/admin/adminRetrieve.do", "pageDoRetrieve");
%>
        ...
        <c:when test="${list.size() > 0}">
          <c:forEach var="vo" items="${list}">
            <tr title="더블클릭하면 상세 정보를 볼 수 있습니다.">
              ...
              <td class="table-cell text-left">${vo.phone}</td>
...
<jsp:include page="/WEB-INF/views/admin/admin_mng.jsp"></jsp:include>