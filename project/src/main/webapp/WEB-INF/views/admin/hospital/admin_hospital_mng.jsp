...
<script src="${CP}/resources/assets/js/admin/hospital/admin_hospital_mng.js?date=<%=new Date()%>"></script>
<div id="hospitalMngmodal" class="modal">
    ...
    <div class="form-area">
      ...
      <form action="#" class="form">
        <div class="form-group">
          ...
          <input type="text" name="hospital_id" id="hospital_id" maxlength="30" disabled="disabled">
        </div>
        <br>
        <div class="form-group">
          <label for="hospital_name">병원 이름</label>
          <input type="text" name="hospital_name" id="hospital_name" maxlength="30" disabled="disabled">
        </div>
        <br>
        <div class="form-group">
          <label for="hospital_addr">병원 주소</label>
          <input type="text" name="hospital_addr" id="hospital_addr" maxlength="100" disabled="disabled">
        </div>
        <br>
        <div class="form-group">
