...
<script src="${CP}/resources/assets/js/admin/member/admin_member_mng.js?date=<%=new Date()%>"></script>
<div id="memberMngModal" class="modal">
    ...
    <div class="form-area">
      ...
      <form action="#" class="form">
        ...
        <div class="form-group">
          ...
          <input type="text" name="birthDt" id="birthDt" maxlength="14">
        </div>
        <br>
        <div class="form-group">
