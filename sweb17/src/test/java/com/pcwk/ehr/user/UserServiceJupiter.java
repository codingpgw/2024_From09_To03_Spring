...
import static com.pcwk.ehr.user.service.UserService.MIN_RECOMMEND_COUNT_FOR_GOLD;
...
class UserServiceJupiter {
	...
	void setUp() throws Exception {
		...
		users = Arrays.asList(new UserVO("james01", "이상무01", "4321", "사용하지 않음", MIN_LOGIN_COUNT_FOR_SILVER - 1, 0,
				Level.BASIC, "1026rjsdnd@naver.com")// 등업 대상 아님 jamesol@paran.com
				, new UserVO("james02", "이상무02", "4321", "SILVER 등업", MIN_LOGIN_COUNT_FOR_SILVER, 0, Level.BASIC,
						"1026rjsdnd@naver.com")// Level.BASIC -> SILVER : 등업대상
				, new UserVO("james03", "이상무03", "4321", "사용하지 않음", MIN_LOGIN_COUNT_FOR_SILVER + 10,
						MIN_RECOMMEND_COUNT_FOR_GOLD - 1, Level.SILVER, "1026rjsdnd@naver.com")// Level.SILVER : 등업대상 아님
				, new UserVO("james04", "이상무04", "4321", "GOLD:등업 대상", MIN_LOGIN_COUNT_FOR_SILVER + 11,
						MIN_RECOMMEND_COUNT_FOR_GOLD, Level.SILVER, "1026rjsdnd@naver.com")// Level.SILVER -> GOLD : 등업
																							// 대상
				, new UserVO("james05", "이상무05", "4321", "GOLD:등업 대상 아님", MIN_LOGIN_COUNT_FOR_SILVER + 40,
						MIN_RECOMMEND_COUNT_FOR_GOLD + 3, Level.GOLD, "1026rjsdnd@naver.com")// Level.GOLD : 등업 대상 아님
		);
	}
